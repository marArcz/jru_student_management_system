...
@section('content')
                            ...
                            <div class="p-6 text-gray-900">
                                    ...
                                    <div class="">
                                        <div class="col-lg-2 col-md-3 col-sm-4 position-relative">
                                            <img class="img-fluid img-thumbnail" src="{{ asset($student->image) }}"
                                                alt="">
                                            <input type="file" accept="image/*" id="profile-pic-input" class="d-none">
                                ...
                                <div class="mt-5">
                                    <div class="flex gap-3 items-center">
                                        <a href="{{ route('students.profile.edit', $student->id) }}"
                                            class="btn btn-primary {{ $student->isVerified() ? 'disabled' : '' }}"
                                            type="button">Edit Information</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Student ID Modal -->
    <div class="modal fade modal-lg" id="id-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
