    ...
    <div class="navbar">
        <div class="container">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a href="{{ route('admin.login') }}" class="nav-link link-secondary">Admin Portal</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('students.auth.register') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{old('firstname')}}" class="form-control" required name="firstname" >
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{old('middlename')}}" class="form-control" required name="middlename">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{old('student_id_no')}}" class="form-control" required name="student_id_no">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password"  value="{{old('password')}}"class="form-control" required name="password"
                                placeholder="Enter your password">
                            <x-input-error :messages="$errors->get('password')" class="mt-2 ps-0" />
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label text-secondary fw-semibold">Confirm Password</label>
                            <input type="password" value="{{old('password_confirmation')}}" class="form-control" required name="password_confirmation"
                        ...
                        <div class="text-center mt-3">
                            <a class="link-secondary" href="{{route('students.auth.index')}}">Already have account</a>
                        </div>
                    </form>
                </div>
            </div>
